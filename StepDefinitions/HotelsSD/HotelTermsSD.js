...
When(/^I switch window handle to Terms and Conditions page$/, async function() {
...
When(/^I switch window handle back to signup page again$/, async function() {
    await hotelsignup.switchingToSignUpHandle();
    await browser.pause(2000);
})
...
When(/^I switch handle window handle to Privacy Statement page$/, async function() {
